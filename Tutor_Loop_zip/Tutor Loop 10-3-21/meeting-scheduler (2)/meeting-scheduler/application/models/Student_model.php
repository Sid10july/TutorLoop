...
{
      var $column_order = [null, 'firstname', 'lastname','username','student_id', null]; //set column field database for datatable orderable
      var $column_search = ['firstname','lastname','username','student_id']; //set column field database for datatable searchable
      ...
      private function _get_query()
      {
            ...
            $this->db->where(['is_deleted' => 0,'role_fid' =>4]);

...
{
      var $column_order = [null, 'firstname', null]; //set column field database for datatable orderable
      var $column_search = ['firstname']; //set column field database for datatable searchable
      var $order = ['user_id' => 'asc']; // default order
      ...
      private function _get_query()
      {
            ...
            $this->db->where(['is_deleted' => 0,'role_fid' =>3]);

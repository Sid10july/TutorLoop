...
<section role="main" class="content-body">
      ...
      <section class="panel custom_panel_margin">
            ...
            <div class="panel-body">
                 ...
                 <form id="form-filter" method="post" action="<?= site_url('Student_meeting/export_meeting') ?>">
...
<script src="<?php echo base_url() ?>assets/custom-js/student_meeting/student_meeting.js"></script>

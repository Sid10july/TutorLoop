...
<html class="fixed">
   <head>
      ...
      <!-- Basic -->
      <meta charset="UTF-8" />
      <meta name="keywords" content="Tutor Loop Login" />
      <meta name="description" content="Tutor Loop Login" />
      <meta name="author" content="Tutor Loop Login" />
      <!-- Mobile Metas -->
         ...
         <div class="center-sign">
            ...
            <div class="panel panel-sign">
               ...
               <div class="panel-body">
                  <h4 class="text-center text-bold">Student Sign Up</h4>
                  <hr>
                  <form id="student-sign-up-form" method="post">

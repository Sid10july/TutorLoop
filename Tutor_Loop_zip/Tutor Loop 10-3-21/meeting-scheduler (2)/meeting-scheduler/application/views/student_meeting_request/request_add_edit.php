      ...
      <div class="panel-body">
         ...
         <div class="row">
             ...
             <div class="col-md-8 form-group">
                  <form id="meeting-request-form" method="post">
            <!--  <div class="row form-group">
               <label class="col-md-3 control-label">My Name </label>
               <div class="col-md-6">
           ...
           <div class="row form-group">
            ...
            <div class="row">
               <div class="col-sm-12">
                 ...
                 <input class="form-control" type="hidden" name="student_fid" value="<?= ucfirst($_SESSION['user_id']) ?>">
